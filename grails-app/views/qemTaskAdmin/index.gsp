...
<body >
	<div  ng-app="tAdminApp"  class="container" ng-controller="defaultCtrl">	
	<div class="col-sm-2 sidebar">
			<div class="list-group">
			<a class="list-group-item list-group-item-info statis" href="#">过程管理</a>	
				<a class="list-group-item statis" href="#"  ng-class="{'active':actived[7]}" ui-sref="taskSummary" <%-- ng-click="tasksummary()" --%>>已立项项目汇总</a>			
				<a class="list-group-item statis" href="#"  ng-class="{'active':actived[0]}" ng-click="tasks()">合同审核</a>	
				<a class="list-group-item statis" href="#"  ng-class="{'active':actived[1]}" ng-click="annual()">年度检查</a>
				<a class="list-group-item statis" href="#"  ng-class="{'active':actived[2]}" ng-click="mid()">中期检查</a>
				<a class="list-group-item statis" href="#"  ng-class="{'active':actived[3]}" ng-click="end()">结题</a>
				<a class="list-group-item statis" href="#"  ng-class="{'active':actived[4]}" ng-click="confirmed()">分配专家</a>
				<a class="list-group-item statis" href="#"  ng-class="{'active':actived[5]}" ng-click="recorded()">评审结果登记</a>
			</div>	
		</div>
