<div class="modal-header"> 
    ...
    <div class="row">
		...
		<span class="col-md-2 text-right"><label class="form-control-static">审批状态</label></span>
		<span class="col-md-2"><select class="form-control input-sm" ng-model="trial.status"  ng-options="y.id as y.name for y in statuses"  ><option value="">全选</option></select></span>
