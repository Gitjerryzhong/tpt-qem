...
<div class="col-sm-3" ng-if="!form.status">
...
<div class="bs-docs-sidebar affix panel panel-info">
    ...
    <div class="panel-footer">
 			<button class="btn btn-success" ng-click="" ng-disabled="myForm.$invalid || trial.content.length<6"> 同意</button>
			<button class="btn btn-warning" ng-click="" ng-disabled="myForm.$invalid || trial.content.length<6"> 不同意</button>
			<button class="btn btn-danger" ng-click="" ng-disabled="myForm.$invalid || trial.content.length<6"> 退回</button>
