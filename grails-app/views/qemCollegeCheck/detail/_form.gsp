...
<div class="form-group striped">
    <label for="discipline" class="col-sm-1 control-label">学科</label>
    <div class="col-sm-2 form-control-static">
    ...
    <label for="direction" class="col-sm-1 control-label">方向</label>
    <div class="col-sm-2 form-control-static">
...
<div class="form-group">
<h4 class="col-md-offset-4 col-md-4 control-label" style="text-align:center;padding-bottom:15px"><strong>附    件</strong><a href="/tms/qemCollegeCheck/downloadAttch/{{project.id}}">（下载全部<span class="glyphicon glyphicon-download-alt"></span>）</a></h4>
</div>
