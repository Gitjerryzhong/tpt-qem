...
<h4 class="col-sm-offset-4 col-sm-4 control-label" style="text-align:center;padding-bottom:15px"><strong>上传申报书</strong></h4>
</div>

 <div class="form-group"> 
    <label for="doc" class="col-sm-2 control-label">申报书</label>
    <div class="col-sm-10">
