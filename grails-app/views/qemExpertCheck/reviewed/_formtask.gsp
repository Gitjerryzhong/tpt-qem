		...
		<table class="table table-bordered" id="mytable">
			...
			<tbody id="listBody">
				...
				<tr>
					...
					<td colspan="2" id="finalResult"><span><input type="radio" name="result" ng-model="review.result" value="0" required>同意立项</span><span> <input type="radio" name="result"  ng-model="review.result" value="1" required>不予立项</span><span><input type="radio" name="result"  ng-model="review.result" value="2" required>弃权</span></td>
				</tr>
				<tr>
					<td colspan="2"><strong>评审意见</strong></td>
					<td colspan="2"><textarea rows="4" cols="70" ng-model="review.content" required></textarea></td>
				</tr>
			</tbody>
		</table>
</div>
<div class="modal-footer">
<input type="button" class="btn btn-default" ng-click="saveTask()" value="保存" ng-disabled="myForm.$invalid">
<input type="button" class="btn btn-default" ng-click="commitTask()" value="提交" ng-disabled="myForm.$invalid">
</div>
</form>