...
<div class="row">
	<div class="col-sm-3">
		<div class="text-center panel panel-info"  toolTip="点击查看原文件"><p>证书</p><a href="tpt/showImage?filename=certi_" target="_blank"><img alt="证书" src="{{imgs.cert}}" width="auto" height="192" style="text-align: center;max-width:150px"></a></div>
	</div>	
	<div class="col-sm-3">
		<div class="text-center panel panel-info"  toolTip="点击查看原文件"><p>国外本科成绩</p><a href="tpt/showImage?filename=trans_1" target="_blank"><img alt="国外本科成绩" src="{{imgs.trans1}}" width="auto" height="192" style="text-align: center;max-width:150px"></a></div>
	</div>	
	<div class="col-sm-3">
		<div class="text-center panel panel-info" toolTip="点击查看原文件"><p>国外硕士成绩</p><a href="tpt/showImage?filename=trans_2" target="_blank"><img alt="国外硕士成绩" src="{{imgs.trans2}}" width="auto" height="192" style="text-align: center;max-width:150px"></a></div>
	</div>	
	<div class="col-sm-3">
		<div class="text-center panel panel-info" toolTip="点击查看原文件"><p>成绩3</p><a href="tpt/showImage?filename=trans_3" target="_blank"><img alt="成绩3" src="{{imgs.trans3}}" width="auto" height="192" style="text-align: center;max-width:150px"></a></div>
	</div>	
</div>
	<div class="form-group well" ng-show="contact.status==4">
		<div class="col-sm-9">
	    <label class="col-sm-2 control-label">论文材料</label>
	    <div class="col-sm-10 ">
	    	<ul class="form-control-static" >
	    		<li><span class="glyphicon glyphicon-warning-sign Emphasis" ng-show="!paperFile"></span>论文：<strong>{{paperFile?"√":"上传不成功！"}}</strong></li>
	    		<li><span class="glyphicon glyphicon-warning-sign Emphasis" ng-show="!paperExchFile"></span>论文成绩互认表：<strong>{{paperExchFile?"√":"提交失败！"}}</strong></li>
	    	</ul>
	    </div>
	    </div>
	</div >
