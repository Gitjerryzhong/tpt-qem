updateAdminApp.controller('updateViewCtrl',['$scope','$http','$location','$filter','aboutUpdate',function($scope,$http,$location,$filter,aboutUpdate){ //任务列表
	$scope.trial={};
