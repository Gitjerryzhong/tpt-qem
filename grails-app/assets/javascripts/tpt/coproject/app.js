...
//    $urlRouterProvider.otherwise('/users');
    ...
    .state('cotype', {
        url: '/cotype',
        templateUrl: 'tpt-co-type.html'
    })
    .state('cocountry', {
        url: '/cocountry',
        templateUrl: 'tpt-co-country.html'
    })
    .state('coproject', {
        url: '/coproject',
        templateUrl: 'tpt-co-project.html'
    })
    .state('copro-detail', {
        url: '/copro-detail',
    ...
    .state('users', {
        url: '/users',
        templateUrl: 'tpt-students.html'
    })
    .state('usersAdd', {
        url: '/usersAdd',
        templateUrl: 'tpt-students-add.html'
    });
}]);
